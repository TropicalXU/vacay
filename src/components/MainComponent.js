...
class Main extends Component {
    ...
    render() {
        ...
        const OntarioFeatured = () => {
            return (
                <Ontario location={this.props.locations.filter((location) => location.province === 'Ontario')}
        ...
        const BcFeatured = () => {
            return (
                <BritishColumbia location={this.props.locations.filter((location) => location.province === 'British Columbia')}
                testemonial1={this.props.testemonials.filter((testemonial) => testemonial.featured)[0]}
                testemonial2={this.props.testemonials.filter((testemonial) => testemonial.featured)[1]}
                />
            );
        ...
        const AlbertaFeatured = () => {
            return (
                <Alberta location={this.props.locations.filter((location) => location.province === 'Alberta')}
                testemonial2={this.props.testemonials.filter((testemonial) => testemonial.featured)[1]}
        ...
        const QuebecFeatured = () => {
            return (
                <Quebec location={this.props.location.filter((location) => location.province === 'Quebec')}
                testemonial1={this.props.testemonial.filter((testemonial) => testemonial.featured)[0]}
                testemonial3={this.props.testemonial.filter((testemonial) => testemonial.featured)[2]}
                />
            );
        }
        ...
        const LocationWithId = ({match}) => {
            return (
                <LocationDetail
                location={this.props.locations.filter((location) => location.id === parseInt(match.params.locationId, 10))[0]}
            ...
            <div>
                ...
                <Switch>
                    <Route path='/home' component={ () => 
                        <Home location1={this.props.locations.filter((location) => location.featured)[0]} 
                              location2={this.props.locations.filter((location) => location.featured)[1]}
                              location3={this.props.locations.filter((location) => location.featured)[2]}
                              testemonial1={this.props.testemonials.filter((testemonial) => testemonial.featured)[0]}
                              testemonial2={this.props.testemonials.filter((testemonial) => testemonial.featured)[1]}
                              testemonial3={this.props.testemonials.filter((testemonial) => testemonial.featured)[2]}
                        /> 
                    }/>
                    <Route exact path='/locations' component={ () => <Locations location={this.props.locations}
                    testemonial1={this.props.testemonials.filter((testemonial) => testemonial.featured)[0]}
                    testemonial3={this.props.testemonials.filter((testemonial) => testemonial.featured)[2]} /> } />
